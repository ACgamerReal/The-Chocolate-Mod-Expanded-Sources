    ...
    public static void registerTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 1,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 2),
                            new ItemStack(ModItems.DRIED_COCOA_BEANS, 5),
                            8, 1, 0.02f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 3,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            ...
                            new ItemStack(ModItems.ROTTEN_CHOCOLATE_BAR, 1),
                            4, 6, 0.04f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 3,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            ...
                            new ItemStack(ModItems.BROWN_CHOCOLATE_SCROLL, 1),
                            2, 10, 0.05f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 3,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 10),
                            new ItemStack(ModItems.WHITE_CHOCOLATE_SCROLL, 1),
                            2, 10, 0.05f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 3,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 10),
                            new ItemStack(ModItems.DARK_CHOCOLATE_SCROLL, 1),
                            2, 10, 0.05f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 4,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            new ItemStack(Items.EMERALD, 10),
                            new ItemStack(ModItems.MUSIC_BOX_CHOCOLATE_DISC, 1),
                            3, 8, 0.04f
                    )));
                });
        ...
        TradeOfferHelper.registerVillagerOffers(CHOCOLATE_VILLAGER, 5,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(
                            ...
                            new ItemStack(ModItems.ICED_CHOCOLATE_BAR, 1),
                            3, 15, 0.03f
                    )));
                });
